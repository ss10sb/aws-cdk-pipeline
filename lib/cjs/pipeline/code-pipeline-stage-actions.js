...
exports.CodePipelineStageActions = void 0;
const aws_codepipeline_actions_1 = require("@aws-cdk/aws-codepipeline-actions");
const util_1 = require("aws-cdk/lib/util");
class CodePipelineStageActions {
    constructor(stage) {
        this.stage = stage;
        this.map = {
            manualApproval: {
...
exports.CodePipelineStageActions = CodePipelineStageActions;
//# sourceMappingURL=code-pipeline-stage-actions.js.map