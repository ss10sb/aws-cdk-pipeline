...
const code_pipeline_stage_steps_1 = require("./code-pipeline-stage-steps");
class CodePipelineEnvStages extends cdk_utils_1.NonConstruct {
    ...
    stepsFromEnvironment(stage, envConfig) {
        const stageSteps = new code_pipeline_stage_steps_1.CodePipelineStageSteps(stage);
