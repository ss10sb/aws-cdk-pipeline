...
exports.PipelinesEnvStages = void 0;
...
class PipelinesEnvStages extends cdk_utils_1.NonConstruct {
    ...
    actionsFromEnvironment(stage, envConfig) {
        const stageActions = new stage_actions_1.PipelinesStageActions(stage);
        stageActions.fromEnvConfig(envConfig);
    }
}
exports.PipelinesEnvStages = PipelinesEnvStages;
