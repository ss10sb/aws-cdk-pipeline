...
const code_star_source_1 = require("../pipeline/code-star-source");
...
const env_stages_1 = require("../pipeline/env-stages");
...
const ecr_steps_1 = require("../pipeline/ecr-steps");
class CodePipelineStack extends cdk_utils_1.ConfigStack {
    ...
    createEcrSteps(props) {
        return new ecr_steps_1.EcrSteps(this, this.getName(), props);
    }
    createEnvironmentStages(props) {
        return new env_stages_1.PipelinesEnvStages(this, 'env-stages', props);
    }
    createPipeline(props) {
        return new pipeline_1.PipelinesPipeline(this, this.getName(), props);
    }
    ...
    createCodeStarSource(props) {
        return new code_star_source_1.PipelinesCodeStarSource(this, this.getName(), props);
    }
    createRepositories() {
    ...
    createSynthStep(pipelineSource) {
        return new synth_step_1.SynthStep(this, this.getName(), {
