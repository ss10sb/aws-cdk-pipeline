...
const notification_targets_1 = require("../pipeline/notification-targets");
class CodePipelineStack extends cdk_utils_1.ConfigStack {
    ...
    createPipelineNotifications(pipeline) {
        if (this.config.Parameters.pipelineNotification) {
            let props = this.config.Parameters.pipelineNotification;
            const notificationTargets = new notification_targets_1.NotificationTargets(this, this.getName(), {
