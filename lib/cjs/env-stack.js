...
class EnvStack extends cdk_utils_1.ConfigStack {
    ...
    createCluster() {
        ...
        const clusterFactory = new cluster_factory_1.ClusterFactory(this, this.node.id, {
            ...
            containerInsights: (_b = this.config.Parameters.containerInsights) !== null && _b !== void 0 ? _b : false,
        });
    ...
    createTargetGroup() {
        const tg = new alb_target_group_1.AlbTargetGroup(this, this.getName('tg'), this.vpc, this.config);
